...
def income_statement(
    ...
    revenue_lines = [
        IncomeStatementLine(name=k, amount=round(v, 2)) for k, v in sorted(rev_by_name.items())
    ]
    expense_lines = [
        IncomeStatementLine(name=k, amount=round(v, 2)) for k, v in sorted(exp_by_name.items())
    ]

...
@router.get("/business/{business_id}", dependencies=[Depends(require_membership_dep())])
def brief_by_business(
    ...
    return build_brief(business_id=str(business_id), facts=facts_obj, signals=signals)
